...
blastp -num_threads 40 -db refseq_viral_protein_db  -query /fs/ess/PAS0439/MING/virome/checkv_trimmed_for_dowmstream/taxonomy/diamond/vOTU_below_10kb_for_blastp.part_${part}.faa  -evalue  0.001 -out /fs/ess/PAS0439/MING/virome/checkv_trimmed_for_dowmstream/taxonomy/output/refseq_virus_below10kb_${part}.bln -outfmt "6 qseqid sseqid pident length qlen slen mismatch gapopen qstart qend sstart send evalue bitscore"
