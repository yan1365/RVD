...
def parse_arguments():
	...
	parser.add_argument('-l', dest='length', type=int, metavar='INT', default=0,
		help="minimum alignment length to keep")
	parser.add_argument('-p', dest='pid', type=float, metavar='FLOAT', default=0,
		help="minimum alignment percent identity to keep")		
...
if __name__ == "__main__":
	...
	for alns in yield_alignment_blocks(input):
		alns = prune_alns(alns, min_pid=args["pid"], min_len=args["length"])
