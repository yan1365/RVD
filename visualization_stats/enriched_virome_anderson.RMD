...
lytic_enriched_anno <- lyso_for_plot_percent[lyso_for_plot_percent$lyso_or_lytic == "Lytic" & lyso_for_plot_percent$Enriched == "Enriched", "ncontigs"] %>% unlist()

lyso_enriched_anno = lyso_for_plot_percent[lyso_for_plot_percent$lyso_or_lytic == "Lysogenic" & lyso_for_plot_percent$Enriched == "Enriched", "ncontigs"] %>% unlist()

lytic_not_anno = lyso_for_plot_percent[lyso_for_plot_percent$lyso_or_lytic == "Lytic" & lyso_for_plot_percent$Enriched == "Not enriched", "ncontigs"] %>% unlist()

lyso_not_anno = lyso_for_plot_percent[lyso_for_plot_percent$lyso_or_lytic == "Lysogenic" & lyso_for_plot_percent$Enriched == "Not enriched", "ncontigs"] %>% unlist()
...
clustered_enriched_anno <- cluster_for_plot_percent[cluster_for_plot_percent$Clustered_or_not == "Clustered" & cluster_for_plot_percent$Enriched == "Enriched", "ncontigs"] %>% unlist()

unclustered_enriched_anno = cluster_for_plot_percent[cluster_for_plot_percent$Clustered_or_not == "Unclustered" & cluster_for_plot_percent$Enriched == "Enriched", "ncontigs"] %>% unlist()

clustered_not_anno = cluster_for_plot_percent[cluster_for_plot_percent$Clustered_or_not == "Clustered" & cluster_for_plot_percent$Enriched == "Not enriched", "ncontigs"] %>% unlist()

unclustered_not_anno = cluster_for_plot_percent[cluster_for_plot_percent$Clustered_or_not == "Unclustered" & cluster_for_plot_percent$Enriched == "Not enriched", "ncontigs"] %>% unlist()
